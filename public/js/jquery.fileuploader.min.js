...
!function ($) {
    ...
    $.fn.fileuploader = function (q) {
        return this.each(function (t, r) {
                    ...
                    init: function () {
                        ...
                        switch (e) {
                            ...
                            case"nextInput":
                                ...
                                f.bindUnbindEvents(!1), 0 < sl.length && 0 == sl[sl.length - 1].get(0).files.length ? s = sl[sl.length - 1] : (-1 == sl.indexOf(s) && sl.push(s), sl.push(l), s.after(s = l)), f.bindUnbindEvents(!0);
                                break;
                            case"listInput":
                        ...
                        create: function () {
                            ...
                            var u = d.html.find(".fileuploader-item-image"), i = d.data && d.data.readerSkip,
                                c = function (e) {
                                    var t = $(e);
                                    u.removeClass("fileuploader-no-thumbnail fileuploader-loading").html(t), t.is("img") && t.attr("draggable", "false").on("load error", function (e) {
                                        "error" == e.type && h(!0), m(), null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s)
                                    }), t.is("canvas") && null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s)
                                }, h = function (e) {
                                    u.addClass("fileuploader-no-thumbnail"), u.removeClass("fileuploader-loading").html(d.icon), e && null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s)
                                }, m = function () {
                                    var e = 0;
                            ...
                            if (u.length) {
                                if (d.image = u.html("").addClass("fileuploader-loading"), (-1 < ["image", "video", "audio", "astext"].indexOf(d.format) || d.data.thumbnail) && f.isFileReaderSupported() && !i && (d.appended || n.thumbnails.startImageRenderer || e)) {
                                    if (n.thumbnails.synchronImages && (-1 == f._pfrL.indexOf(d) && !e && f._pfrL.push(d), 1 < f._pfrL.length && !e)) return;
                                    var r = function (e, t) {
                                        var o = e.nodeName && "img" == e.nodeName.toLocaleLowerCase(),
                                            i = o ? e.src : e;
                                        if (n.thumbnails.canvasImage) {
                                            var r = document.createElement("canvas"), a = o ? e : new Image,
                                                l = function () {
                                                    f.editor.resize(this, r, n.thumbnails.canvasImage.width ? n.thumbnails.canvasImage.width : u.width(), n.thumbnails.canvasImage.height ? n.thumbnails.canvasImage.height : u.height(), !1, !0), f._assets.isBlankCanvas(r) ? h() : c(r), m()
                                                }, s = function (e) {
                                                    h(!0), m(), a = null
                                                };
                                            if ("image" == d.format && t && d.reader.node) return l.call(d.reader.node);
                                            if (!i) return s();
                                            if (o) return l.call(e);
                                            a.onload = l, a.onerror = s, d.data && d.data.readerCrossOrigin && a.setAttribute("crossOrigin", d.data.readerCrossOrigin), a.src = i
                                        } else c(o ? e : '<img src="' + i + '">')
                                    };
                                    return "string" == typeof t || "object" == typeof t ? r(t) : f.files.read(d, function () {
                                        d.reader.node && n.thumbnails.popup && d.html.addClass("file-has-popup"), d.reader.node && (d.reader.frame || "img" == d.reader.node.nodeName.toLowerCase()) ? r(d.reader.frame || d.reader.src, !0) : (h("image" == d.format), m())
                                    }, null, t, !0)
                                }
                                h()
                            } else m()
                            ...
                            if (!f.locked && n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                var a = $(n.thumbnails.popup.container), u = a.find(".fileuploader-popup"),
                                    e = function () {
                                        var e = d.popup.html || $(f._assets.textParse(n.thumbnails.popup.template, d)),
                                            t = d.popup.html !== e, i = function (e) {
                                        ...
                                        u.removeClass("loading"), u.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function (e, t) {
                                        ...
                                        }), u.find(n.thumbnails._selectors.popup).remove()), e.show().appendTo(u), d.popup.html = e, d.popup.move = function (e) {
                                            var t = f._itFl.indexOf(d), o = null, i = !1;
                                            if ("prev" == e) for (var r = t; 0 <= r; r--) {
                                                if ((a = f._itFl[r]) != d && a.popup && a.html.hasClass("file-has-popup")) {
                                                    o = a;
                                                    break
                                                }
                                                0 != r || o || i || !n.thumbnails.popup.loop || (r = f._itFl.length, i = !0)
                                            } else for (r = t; r < f._itFl.length; r++) {
                                                var a;
                                                if ((a = f._itFl[r]) != d && a.popup && a.html.hasClass("file-has-popup")) {
                                                    o = a;
                                                    break
                                            ...
                                            d.reader.node && d.reader.node.pause && d.reader.node.pause(), $(window).off("keyup", i), a.css({
                                                overflow: "",
                                                width: ""
                                            }), d.popup.editor && d.popup.editor.cropper && d.popup.editor.cropper.hide(), d.popup.zoomer && d.popup.zoomer.hide(), d.popup.html && n.thumbnails.popup.onHide && $.isFunction(n.thumbnails.popup.onHide) ? n.thumbnails.popup.onHide(d, l, p, o, s) : d.popup.html && d.popup.html.remove(), e || u.fadeOut(400, function () {
                                                u.remove()
                                            }), delete d.popup.close
                                        }, d.reader.node ? (t && e.html(e.html().replace(/\$\{reader\.node\}/, '<div class="reader-node"></div>')).find(".reader-node").html(d.reader.node), d.reader.node.controls = !0, d.reader.node.currentTime = 0, d.reader.node.play && d.reader.node.play()) : t && e.find(".fileuploader-popup-node").html('<div class="reader-node"><div class="fileuploader-popup-file-icon">' + d.icon + "</div></div>"), $(window).on("keyup", i), a.css({
                                            overflow: "hidden",
                                            width: a.innerWidth()
                                        }), d.popup.html.find('[data-action="prev"], [data-action="next"]').removeAttr("style"), d.popup.html[1 != f._itFl.length && n.thumbnails.popup.arrows ? "addClass" : "removeClass"]("fileuploader-popup-has-arrows"), n.thumbnails.popup.loop || (0 == f._itFl.indexOf(d) && d.popup.html.find('[data-action="prev"]').hide(), f._itFl.indexOf(d) == f._itFl.length - 1 && d.popup.html.find('[data-action="next"]').hide()), f.editor.zoom(d), d.editor && (d.popup.editor || (d.popup.editor = {}), f.editor.rotate(d, d.popup.editor.rotation || d.editor.rotation || 0, !0), d.popup.editor && d.popup.editor.cropper && (d.popup.editor.cropper.hide(!0), setTimeout(function () {
                                ...
                                0 == u.length && (u = $('<div class="fileuploader-popup"></div>').appendTo(a)), u.fadeIn(400).addClass("loading"), -1 < ["image", "video", "audio", "astext"].indexOf(d.format) && !d.popup.html ? f.files.read(d, e) : e()
                            }
                        }
                    }, editor: {
                        rotate: function (e, t, o) {
                            if (!(e.popup && e.popup.html && $("html").find(e.popup.html).length)) {
                                var i = e.editor.rotation || 0, r = t || i + 90;
                                ...
                                e.popup.editor.cropper && e.popup.editor.cropper.$template.hide(), e.popup.editor.rotation = o ? t : i + 90, e.popup.editor.scale = (n.height() / p[-1 < [90, 270].indexOf(e.popup.editor.rotation) ? "width" : "height"]()).toFixed(3), p.height() * e.popup.editor.scale > n.width() && -1 < [90, 270].indexOf(e.popup.editor.rotation) && (e.popup.editor.scale = n.height() / p.width()), 1 < e.popup.editor.scale && (e.popup.editor.scale = 1), $(a).stop().animate({
                                    ...
                                    duration: o ? 2 : 300, easing: "swing", step: function (e, t) {
                                        var o = p.css("-webkit-transform") || p.css("-moz-transform") || p.css("transform") || "none",
                                            i = 0, r = 1, n = t.prop;
                                        if ("none" !== o) {
                                            var a = o.split("(")[1].split(")")[0].split(","), l = a[0], s = a[1];
                                            i = "rotation" == n ? e : Math.round(Math.atan2(s, l) * (180 / Math.PI)), r = "scale" == n ? e : Math.round(10 * Math.sqrt(l * l + s * s)) / 10
                                        }
                                        p.css({
                                            "-webkit-transform": "rotate(" + i + "deg) scale(" + r + ")",
                                            "-moz-transform": "rotate(" + i + "deg) scale(" + r + ")",
                                            transform: "rotate(" + i + "deg) scale(" + r + ")"
                                        })
                                    }, always: function () {
                            ...
                            if (!(b.popup && b.popup.html && $("html").find(b.popup.html).length)) return b.editor.crop = e || b.editor.crop;
                            if (b.reader.node) if (b.popup.editor.cropper) e && (b.popup.editor.cropper.crop = e), b.popup.editor.cropper.init(e); else {
                                var t = b.popup.html.find(".fileuploader-popup-node .reader-node > img"),
                                ...
                                b.popup.editor.cropper = {
                                    ...
                                    crop: e || null,
                                    init: function (o) {
                                        var i = b.popup.editor.cropper, e = i.$imageEl.position(),
                                            t = i.$imageEl[0].getBoundingClientRect().width,
                                            r = i.$imageEl[0].getBoundingClientRect().height,
                                            a = b.popup.editor.rotation && -1 < [90, 270].indexOf(b.popup.editor.rotation) ? b.popup.editor.scale : 1;
                                        ...
                                        }, 400), n.editor.cropper && n.editor.cropper.showGrid && i.$editor.addClass("has-grid"), i.$imageEl.attr("draggable", "false"), i.$template.on("mousedown touchstart", i.mousedown), $(window).on("resize", i.resize), i.isCropping = !0, b.popup.editor.hasChanges = !0
                                    },
                                    setDefaultData: function () {
                                        var e = b.popup.editor.cropper, t = e.$imageEl, o = t.width(), i = t.height(),
                                            r = b.popup.editor.rotation && -1 < [90, 270].indexOf(b.popup.editor.rotation),
                                            n = b.popup.editor.scale || 1;
                                        return e.crop = {
                                            left: 0,
                                            top: 0,
                                            width: r ? i * n : o,
                                            height: r ? o * n : i,
                                            cfWidth: o / b.reader.width,
                                            cfHeight: i / b.reader.height
                                        }, null
                                    },
                                    hide: function (e) {
                                        var t = b.popup.editor.cropper;
                                    ...
                                    resize: function (e) {
                                        ...
                                        }, 500)) : (o.crop.cfWidth = i.width() / b.reader.width, o.crop.cfHeight = i.height() / b.reader.height))
                                    },
                                    drawPlaceHolder: function (e) {
                                        var t = b.popup.editor.cropper, o = b.popup.editor.rotation || 0,
                                            i = b.popup.editor.scale || 1, r = [0, 0];
                                        e && (e = $.extend({}, e), o && (r = [180 == o || 270 == o ? -100 : 0, 90 == o || 180 == o ? -100 : 0]), t.$editor.css(e), t.setAreaInfo(), t.$editor.find(".area-image img").removeAttr("style").css({
                                            width: t.$imageEl.width(),
                                            height: t.$imageEl.height(),
                                            left: -1 * t.$editor.position().left,
                                            top: -1 * t.$editor.position().top,
                                            "-webkit-transform": "rotate(" + o + "deg) scale(" + i + ") translateX(" + r[0] + "%) translateY(" + r[1] + "%)",
                                            "-moz-transform": "rotate(" + o + "deg) scale(" + i + ") translateX(" + r[0] + "%) translateY(" + r[1] + "%)",
                                            transform: "rotate(" + o + "deg) scale(" + i + ") translateX(" + r[0] + "%) translateY(" + r[1] + "%)"
                                        }))
                                    },
                                    setAreaInfo: function (e) {
                                        var t = b.popup.editor.cropper, o = b.popup.editor.scale || 1;
                                    ...
                                    mousedown: function (e) {
                                        var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                            o = $(e.target), i = b.popup.editor.cropper, r = {
                                                x: ("mousedown" == t ? e.pageX : e.originalEvent.touches[0].pageX) - i.$template.offset().left,
                                                y: ("mousedown" == t ? e.pageY : e.originalEvent.touches[0].pageY) - i.$template.offset().top
                                            }, a = function () {
                                                i.pointData = {
                                                    el: o,
                                                    x: r.x,
                                                    y: r.y,
                                                    xEditor: r.x - i.crop.left,
                                                    yEditor: r.y - i.crop.top,
                                                    left: i.crop.left,
                                                    top: i.crop.top,
                                                    width: i.crop.width,
                                                    height: i.crop.height
                                                }, (i.isMoving || i.isResizing) && (i.setAreaInfo("size"), i.$editor.addClass("moving show-info"), $("body").css({
                                                    "-webkit-user-select": "none",
                                                    "-moz-user-select": "none",
                                                    "-ms-user-select": "none",
                                                    "user-select": "none"
                                                }), $(window).on("mousemove touchmove", i.mousemove))
                                            };
                                        b.popup.zoomer && b.popup.zoomer.hasSpacePressed || (i.isMoving = o.is(".area-move"), i.isResizing = o.is(".point"), "mousedown" == t && a(), "touchstart" == t && 1 == e.originalEvent.touches.length && ((i.isMoving || i.isResizing) && e.preventDefault(), i.isTouchLongPress = !0, setTimeout(function () {
                                            i.isTouchLongPress && (delete i.isTouchLongPress, a())
                                        }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(window).on("mouseup touchend", i.mouseup))
                                    },
                                    mousemove: function (e) {
                                        var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                            o = ($(e.target), b.popup.editor.cropper), i = {
                                        ...
                                        if (o.isMoving) {
                                            var r = i.x - o.pointData.xEditor, a = i.y - o.pointData.yEditor;
                                        ...
                                        if (o.isResizing) {
                                            var l, s = o.pointData.el.attr("class").substr("point point-".length),
                                                p = o.crop.left + o.crop.width, d = o.crop.top + o.crop.height,
                                            ...
                                            if (("c" == s || "d" == s || "e" == s) && !l && (o.crop.width = i.x - o.crop.left, o.crop.width + o.crop.left > o.$template.width() && (o.crop.width = o.$template.width() - o.crop.left), o.crop.width < u && (o.crop.width = u), o.crop.width > h && (o.crop.width = h), (l = g ? f._assets.ratioToPx(o.crop.width, o.crop.height, g) : null) && (o.crop.height = l[1], "c" != s && "d" != s || (o.crop.top = Math.max(0, o.pointData.top + (o.pointData.height - o.crop.height) / ("d" == s ? 2 : 1))), o.crop.top + o.crop.height > o.$template.height()))) {
                                                var w = o.$template.height() - o.crop.top;
                                                o.crop.height = w, o.crop.width = w / l[3] * l[2]
                                            }
                                            if (("a" == s || "g" == s || "h" == s) && !l && (o.crop.left = i.x, o.crop.left > o.$template.width() && (o.crop.left = o.$template.width()), o.crop.left < 0 && (o.crop.left = 0), o.crop.width = p - o.crop.left, o.crop.left > o.crop.left + o.crop.width && (o.crop.left = p, o.crop.width = 0), o.crop.width < u && (o.crop.left = p - u, o.crop.width = u), o.crop.width > h && (o.crop.left = p - h, o.crop.width = h), (l = g ? f._assets.ratioToPx(o.crop.width, o.crop.height, g) : null) && (o.crop.height = l[1], "a" != s && "h" != s || (o.crop.top = Math.max(0, o.pointData.top + (o.pointData.height - o.crop.height) / ("h" == s ? 2 : 1))), o.crop.top + o.crop.height > o.$template.height()))) {
                                                w = o.$template.height() - o.crop.top;
                                                o.crop.height = w, o.crop.width = w / l[3] * l[2], o.crop.left = p - o.crop.width
                                            }
                                        }
                                    ...
                                    mouseup: function (e) {
                                        ...
                                        0 != t.$editor.width() && 0 != t.$editor.height() || t.init(t.setDefaultData()), delete t.isTouchLongPress, delete t.isMoving, delete t.isResizing, t.$editor.removeClass("moving show-info"), $("body").css({
                                            ...
                                            "-ms-user-select": "",
                                            "user-select": ""
                                        }), $(window).off("mousemove touchmove", t.mousemove), $(window).off("mouseup touchend", t.mouseup)
                                    }
                                }, b.popup.editor.cropper.init()
                            }
                        }, resize: function (e, t, o, i, r, n) {
                            var a = t.getContext("2d"),
                                l = (o = !o && i ? i * e.width / e.height : o, i = !i && o ? o * e.height / e.width : i, e.width / e.height),
                                s = 1 <= l ? o : i * l, p = l < 1 ? i : o / l;
                            n && s < o && (p *= o / s, s = o), n && p < i && (s *= i / p, p = i);
                            var d = Math.min(Math.ceil(Math.log(e.width / s) / Math.log(2)), 12);
                            if (t.width = s, t.height = p, e.width < t.width || e.height < t.height || d < 2) {
                                n || (t.width = Math.min(e.width, t.width), t.height = Math.min(e.height, t.height));
                                ...
                                for (f.width = e.width / m, f.height = e.height / m, h.fillStyle = "#fff", h.fillRect(0, 0, f.width, f.height), h.drawImage(e, 0, 0, f.width, f.height); 2 < d;) {
                                    var g = m + 2, v = e.width / m, w = e.height / m;
                                    v > f.width && (v = f.width), w > f.height && (w = f.height), h.drawImage(f, 0, 0, v, w, 0, 0, e.width / g, e.height / g), m = g, d--
                                }
                                v = e.width / m, w = e.height / m;
                                v > f.width && (v = f.width), w > f.height && (w = f.height), a.drawImage(f, 0, 0, v, w, 0, 0, s, p), f = h = null
                            }
                            a = null
                        }, zoom: function (s) {
                            if (s.popup && s.popup.html && $("html").find(s.popup.html).length) {
                                if (!s.popup.zoomer) {
                                    var e = s.popup.html, l = e.find(".fileuploader-popup-node"),
                                        p = l.find(".reader-node"),
                                        d = p.find("> img").attr("draggable", "false").attr("ondragstart", "return false;");
                                    s.popup.zoomer = {
                                        html: e.find(".fileuploader-popup-zoomer"),
                                        isActive: "image" == s.format && s.reader.node && n.thumbnails.popup.zoomer,
                                        scale: 100,
                                        zoom: 100,
                                        init: function () {
                                            var e = this;
                                            if (!e.isActive || f._assets.isIE() || f._assets.isMobile()) return e.html.hide() && p.addClass("has-node-centered");
                                            e.hide(), e.resize(), $(window).on("resize", e.resize), $(window).on("keyup keydown", e.keyPress), e.html.find("input").on("input change", e.range), p.on("mousedown touchstart", e.mousedown), l.on("mousewheel DOMMouseScroll", e.scroll)
                                        },
                                        hide: function () {
                                            var e = this;
                                            $(window).off("resize", e.resize), $(window).off("keyup keydown", e.keyPress), e.html.find("input").off("input change", e.range), p.off("mousedown", e.mousedown), l.off("mousewheel DOMMouseScroll", e.scroll)
                                        },
                                        center: function (e) {
                                            var t = this, o = 0, i = 0;
                                            i = e ? (o = t.left, i = t.top, o -= (l.width() / 2 - t.left) * (p.width() / e[0] - 1), i -= (l.height() / 2 - t.top) * (p.height() / e[1] - 1), p.width() <= l.width() && (o = Math.round((l.width() - p.width()) / 2)), p.height() <= l.height() && (i = Math.round((l.height() - p.height()) / 2)), p.width() > l.width() && (0 < o ? o = 0 : o + p.width() < l.width() && (o = l.width() - p.width())), p.height() > l.height() && (0 < i ? i = 0 : i + p.height() < l.height() && (i = l.height() - p.height())), Math.min(i, 0)) : (o = Math.round((l.width() - p.width()) / 2), Math.round((l.height() - p.height()) / 2)), p.css({
                                                left: (t.left = o) + "px",
                                                top: (t.top = i) + "px"
                                            })
                                        },
                                        resize: function () {
                                            ...
                                            p.removeAttr("style"), e.scale = e.getImageScale(), e.updateView()
                                        },
                                        range: function (e) {
                                        ...
                                        keyPress: function (e) {
                                            ...
                                            32 == (e.keyCode || e.which) && (t.hasSpacePressed = "keydown" == o, t.hasSpacePressed && t.isZoomed() ? p.addClass("is-amoving") : p.removeClass("is-amoving"))
                                        },
                                        mousedown: function (e) {
                                            var t = s.popup.zoomer, o = $(e.target),
                                                i = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                                r = {
                                                    x: "mousedown" == i ? e.pageX : e.originalEvent.touches[0].pageX,
                                                    y: "mousedown" == i ? e.pageY : e.originalEvent.touches[0].pageY
                                                }, a = function () {
                                                    t.pointData = {
                                                        x: r.x,
                                                        y: r.y,
                                                        ...
                                                        "-ms-user-select": "none",
                                                        "user-select": "none"
                                                    }), p.addClass("is-moving"), $(window).on("mousemove", t.mousemove)
                                                };
                                            1 == e.which && 100 != t.scale && t.zoom != t.scale && (t.hasSpacePressed || o[0] == d[0] || o.is(".fileuploader-cropper")) && ("mousedown" == i && a(), "touchstart" == i && (t.isTouchLongPress = !0, setTimeout(function () {
                                                t.isTouchLongPress && (delete t.isTouchLongPress, a())
                                            }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(window).on("mouseup touchend", t.mouseup))
                                        },
                                        mousemove: function (e) {
                                            var t = s.popup.zoomer,
                                                ...
                                                r = "mousedown" == o ? e.pageY : e.originalEvent.touches[0].pageY,
                                                n = i - t.pointData.xTarget, a = r - t.pointData.yTarget;
                                            0 < a && (a = 0), a < l.height() - p.height() && (a = l.height() - p.height()), p.height() < l.height() && (a = l.height() / 2 - p.height() / 2), p.width() > l.width() ? (0 < n && (n = 0), n < l.width() - p.width() && (n = l.width() - p.width())) : n = l.width() / 2 - p.width() / 2, p.css({
                                                left: (t.left = n) + "px",
                                                top: (t.top = a) + "px"
                                            })
                                        },
                                        mouseup: function (e) {
                                            ...
                                            delete t.pointData, $("body").css({
                                                ...
                                                "-ms-user-select": "",
                                                "user-select": ""
                                            }), p.removeClass("is-moving"), $(window).off("mousemove", t.mousemove), $(window).off("mouseup", t.mouseup)
                                        },
                                        zoomIn: function (e) {
                                        ...
                                        updateView: function (e, t) {
                                            var o = this, i = o.getImageSize().width / 100 * e,
                                                r = o.getImageSize().height / 100 * e, n = p.width(), a = p.height(),
                                                l = e && e != o.scale;
                                            if (!o.isActive) return o.center();
                                            l ? p.addClass("is-movable").css({
                                                width: i + "px",
                                                height: r + "px",
                                                maxWidth: "none",
                                                maxHeight: "none"
                                            }) : p.removeClass("is-movable is-amoving").removeAttr("style"), o.zoom = e || o.scale, o.center(l ? [n, a, o.left, o.top] : null), o.html.find("span").html(o.zoom + "%"), t || o.html.find("input").val(o.zoom), e && s.popup.editor && s.popup.editor.cropper && s.popup.editor.cropper.resize(!0)
                                        },
                                        isZoomed: function () {
                                            return this.zoom > this.scale
                                        },
                                        getImageSize: function () {
                                            return {width: d.prop("naturalWidth"), height: d.prop("naturalHeight")}
                                        },
                                        getImageScale: function () {
                                            return Math.round(100 / (d.prop("naturalWidth") / d.width()))
                                        }
                                    }
                                }
                                s.popup.zoomer.init()
                            }
                        }, save: function (w, b, x, _, y) {
                            var e = w.popup && w.popup.html && $("html").find(w.popup.html).length, t = new Image,
                                i = function () {
                                    if (w.reader.node) {
                                        var t = document.createElement("canvas"), i = t.getContext("2d"), e = [0, 180];
                                        if (t.width = w.reader.width, t.height = w.reader.height, i.drawImage(this, 0, 0, w.reader.width, w.reader.height), void 0 !== w.editor.rotation) {
                                            w.editor.rotation = w.editor.rotation || 0, t.width = -1 < e.indexOf(w.editor.rotation) ? w.reader.width : w.reader.height, t.height = -1 < e.indexOf(w.editor.rotation) ? w.reader.height : w.reader.width;
                                            var r = w.editor.rotation * Math.PI / 180, a = .5 * t.width,
                                                d = .5 * t.height;
                                            i.clearRect(0, 0, t.width, t.height), i.translate(a, d), i.rotate(r), i.translate(.5 * -w.reader.width, .5 * -w.reader.height), i.drawImage(this, 0, 0), i.setTransform(1, 0, 0, 1, 0, 0)
                                        }
                                        if (w.editor.crop) {
                                            var u = i.getImageData(w.editor.crop.left, w.editor.crop.top, w.editor.crop.width, w.editor.crop.height);
                                            t.width = w.editor.crop.width, t.height = w.editor.crop.height, i.putImageData(u, 0, 0)
                                        }
                                        var c = x || w.type || "image/jpeg", h = n.editor.quality || 90,
                                            m = t.toDataURL(c, h / 100), g = function (e, t) {
                                                var i = b ? f._assets.dataURItoBlob(e, c) : e;
                                                !y && f.thumbnails.renderThumbnail(w, !0, t || e), _ && _(i, w, l, p, o, s), null != n.editor.onSave && "function" == typeof n.editor.onSave && n.editor.onSave(i, w, l, p, o, s), f.set("listInput", null)
                                            };
                                        if (n.editor.maxWidth || n.editor.maxHeight) {
                                            var v = new Image;
                                            v.src = m, v.onload = function () {
                                                var e = document.createElement("canvas");
                                                f.editor.resize(v, e, n.editor.maxWidth, n.editor.maxHeight, !0, !1), m = e.toDataURL(c, h / 100), g(m, v), t = i = e = null
                                            }
                                        } else g(m), t = i = null
                                    }
                                };
                            if (e) {
                                if (!w.popup.editor.hasChanges) return;
                                var r = w.popup.editor.scale || 1;
                                w.editor.rotation = w.popup.editor.rotation || 0, w.popup.editor.cropper && (w.editor.crop = w.popup.editor.cropper.crop, w.editor.crop.width = w.editor.crop.width / w.popup.editor.cropper.crop.cfWidth / r, w.editor.crop.left = w.editor.crop.left / w.popup.editor.cropper.crop.cfWidth / r, w.editor.crop.height = w.editor.crop.height / w.popup.editor.cropper.crop.cfHeight / r, w.editor.crop.top = w.editor.crop.top / w.popup.editor.cropper.crop.cfHeight / r)
                            }
                            f._assets.isMobile() ? (t.onload = i, t.src = w.reader.src) : w.reader.node ? i.call(w.reader.node) : w.reader.read(function () {
                                i.call(w.reader.node)
                            })
                        }
                    }, sorter: {
                        init: function () {
                            ...
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                o = $(e.target), i = o.closest(n.thumbnails._selectors.item), r = f.files.find(i), a = {
                                    x: "mousedown" != t && i.length ? e.originalEvent.touches[0].pageX : e.pageX,
                                    y: "mousedown" != t && i.length ? e.originalEvent.touches[0].pageY : e.pageY
                                }, s = function () {
                                    f.sorter.sort = {
                                        el: o,
                                        item: r,
                                        ...
                                        x: a.x,
                                        y: a.y,
                                        xItem: a.x - i.offset().left,
                                        yItem: a.y - i.offset().top,
                                        left: i.position().left,
                                        top: i.position().top,
                                        width: i.outerWidth(),
                                        height: i.outerHeight(),
                                        placeholder: n.sorter.placeholder ? $(n.sorter.placeholder) : r.html.clone().addClass("fileuploader-sorter-placeholder").html("")
                                    }, $("body").css({
                                        "-webkit-user-select": "none",
                                        "-moz-user-select": "none",
                                        "-ms-user-select": "none",
                            ...
                            f.sorter.sort && f.sorter.mouseup(), r && (n.sorter.selectorExclude && (o.is(n.sorter.selectorExclude) || o.closest(n.sorter.selectorExclude).length) || (p.on(f.sorter.prevent(!0), n.thumbnails._selectors.sorter, f.sorter.prevent), "mousedown" == t && s(), "touchstart" == t && (f.sorter.isTouchLongPress = !0, setTimeout(function () {
                                f.sorter.isTouchLongPress && (delete f.sorter.isTouchLongPress, s())
                            }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(window).on("mouseup touchend", f.sorter.mouseup)))
                        }, findItemAtPos: function (i) {
                            var e = f.sorter.sort, t = e.items.not(e.item.html), r = null;
                            return t.each(function (e, t) {
                                var o = $(t);
                                if (i.x > o.offset().left && i.x < o.offset().left + o.outerWidth() && i.y > o.offset().top && i.y < o.offset().top + o.outerHeight()) return r = o, !1
                            }), r
                        }, mousemove: function (e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                o = f.sorter.sort, i = o.item, r = l.find(n.thumbnails._selectors.item),
                                a = $(n.sorter.scrollContainer || window),
                                s = {left: a.scrollLeft(), top: a.scrollTop()}, p = {
                                    x: "mousedown" == t ? e.pageX : e.originalEvent.touches[0].pageX,
                                    y: "mousedown" == t ? e.pageY : e.originalEvent.touches[0].pageY
                                }, d = p.x - o.xItem - s.left, u = p.y - o.yItem - s.top;
                            d + o.xItem > a.width() && (d = a.width() - o.xItem), d < 0 - o.xItem && (d = 0 - o.xItem), u + o.yItem > a.height() && (u = a.height() - o.yItem), u < 0 - o.yItem && (u = 0 - o.yItem), i.html.addClass("sorting").css({
                                position: "fixed",
                                left: d,
                                top: u,
                            ...
                            var c = f.sorter.findItemAtPos({x: d + o.xItem + s.left, y: u + o.yItem + s.top});
                            if (c) {
                                ...
                                var g = r.index(i.html), v = r.index(c) < g ? "before" : "after";
                                c[v](o.placeholder), c[v](i.html), f.sorter.sort.lastHover = {
                                    el: c[0],
                                    x: p.x,
                                    y: p.y,
                                    direction: v
                            ...
                            $.each(t, function (e, t) {
                                ...
                                if (o) {
                                    if (o.upload && !o.uploaded) return a = !1;
                                    f.rendered && o.index != i && (a = !0), o.index = i, r.push(o), i++
                                }
                            }), a && r.length == f._itFl.length && (f._itFl = r), e || f.set("listInput", "ignoreSorter"), a && null != n.sorter.onSort && "function" == typeof n.sorter.onSort && n.sorter.onSort(r, l, p, o, s)
                        }
                    }, upload: {
                        prepare: function (t, e) {
                            ...
                            if (a.upload) {
                                var d = function (e) {
                                    a.html.removeClass("upload-pending upload-loading upload-cancelled upload-failed upload-success").addClass("upload-" + (e || a.upload.status))
                                }, r = function () {
                                    var e = 0;
                                ...
                                if (n.upload.chunk && a.file.slice) {
                                    var t = 1e6 * n.upload.chunk, i = Math.ceil(a.size / t, t);
                                    if (1 < i && !a.upload.chunk && (a.upload.chunk = {
                                        ...
                                        total: i,
                                        i: -1
                                    }), a.upload.chunk) if (a.upload.chunk.i++, delete a.upload.chunk.isFirst, delete a.upload.chunk.isLast, 0 == a.upload.chunk.i && (a.upload.chunk.isFirst = !0), a.upload.chunk.i == a.upload.chunk.total - 1 && (a.upload.chunk.isLast = !0), a.upload.chunk.i <= a.upload.chunk.total - 1) {
                                        var u = a.upload.chunk.i * a.upload.chunk.chunkSize,
                                            c = a.file.slice(u, u + a.upload.chunk.chunkSize);
                                        a.upload.data = n.upload.data || {}, a.upload.formData = new FormData, a.upload.formData.append(s.attr("name"), c), a.upload.data._chunkedd = JSON.stringify(a.upload.chunk)
                                ...
                                if (p.addClass("fileuploader-is-uploading"), a.upload.$ajax && a.upload.$ajax.abort(), delete a.upload.$ajax, delete a.upload.send, a.upload.status = "loading", a.html && (n.thumbnails._selectors.start && a.html.find(n.thumbnails._selectors.start).remove(), d()), a.upload.data) for (var h in a.upload.data) a.upload.formData.append(h, a.upload.data[h]);
                                a.upload.data = a.upload.formData, a.upload.xhr = function () {
                                    var e = $.ajaxSettings.xhr(),
                                        t = a.upload.chunk && a.upload.chunk.xhrStartedAt ? a.upload.chunk.xhrStartedAt : new Date;
                                    return e.upload && e.upload.addEventListener("progress", function (e) {
                                        a.upload.$ajax && (a.upload.$ajax.total = a.upload.chunk ? a.upload.chunk.size : e.total, a.upload.$ajax.xhrStartedAt = t), f.upload.progressHandling(e, a, t)
                                    }, !1), e
                                }, a.upload.complete = function (e, t) {
                                    if (a.upload.chunk && !a.upload.chunk.isLast && "success" == t) return f.upload.send(a);
                                    r();
                                    var i = !0;
                                    ...
                                    if (!a.upload.chunk || a.upload.chunk.isLast) delete a.upload.chunk, f.upload.progressHandling(null, a, a.upload.$ajax.xhrStartedAt, !0), a.uploaded = !0, delete a.upload, a.upload = {
                                        status: "successful",
                                        resend: function () {
                                            f.upload.retry(a)
                                        }
                                    ...
                                    a.uploaded = !1, a.upload.status = "cancelled" == a.upload.status ? a.upload.status : "failed", delete a.upload.$ajax, a.html && d(), null != n.upload.onError && $.isFunction(n.upload.onError) && n.upload.onError(a, l, p, o, s, e, t, i)
                            ...
                            if (!e && r && t.upload.$ajax && (e = {
                                ...
                                var a = e.loaded + (t.upload.chunk ? t.upload.chunk.loaded : 0),
                                    d = t.upload.chunk ? t.upload.chunk.size : e.total, u = Math.round(100 * a / d),
                                    c = t.upload.chunk && t.upload.chunk.xhrStartedAt ? t.upload.chunk.xhrStartedAt : i,
                                    h = ((new Date).getTime() - c.getTime()) / 1e3, m = h ? a / h : 0,
                                    g = Math.max(0, d - a), v = Math.max(0, h ? g / m : 0), w = {
                                        loaded: a,
                        ...
                        paste: function (e) {
                            if (f._assets.isIntoView(o) && e.originalEvent.clipboardData && e.originalEvent.clipboardData.items && e.originalEvent.clipboardData.items.length) {
                                ...
                                for (var i = 0; i < t.length; i++) if (-1 !== t[i].type.indexOf("image") || -1 !== t[i].type.indexOf("text/uri-list")) {
                                    var r = t[i].getAsFile(), a = 1 < n.clipboardPaste ? n.clipboardPaste : 2e3;
                                    r && (r._name = f._assets.generateFileName(-1 != r.type.indexOf("/") ? r.type.split("/")[1].toString().toLowerCase() : "png", "Clipboard "), f.set("feedback", f._assets.textParse(n.captions.paste, {ms: a / 1e3})), f.clipboard._timer = setTimeout(function () {
                        ...
                        add: function (e, t) {
                            var o, r, i = e._name || e.name, a = e.size, l = f._assets.bytesToText(a), p = e.type,
                                ...
                                c = i.substr(0, i.length - (-1 != i.indexOf(".") ? u.length + 1 : u.length)), h = {
                                    name: i,
                                    title: c,
                                    size: a,
                                    size2: l,
                            ...
                            return "updated" != t ? (f._itFl.push(h), o = f._itFl.length - 1, r = f._itFl[o]) : (o = f._itFl.indexOf(e), f._itFl[o] = r = h), r.remove = function () {
                                f.files.remove(r)
                            ...
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                ...
                                if ("astext" == d.format) a.onload = function (e) {
                                    ...
                                    a.onload = function (e) {
                                        var s = new Image, t = function () {
                                            d.data && d.data.readerCrossOrigin && s.setAttribute("crossOrigin", d.data.readerCrossOrigin), s.src = e.target.result + (!d.data.readerForce && !i || h || c || -1 != e.target.result.indexOf("data:image") ? "" : (-1 == e.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now()), s.onload = function () {
                                                if (d.reader.exifOrientation) {
                                                    var e = document.createElement("canvas"), t = e.getContext("2d"),
                                                        o = s, i = d.reader.exifOrientation, r = [0, 180];
                                                    e.width = o.naturalWidth, e.height = o.naturalHeight, t.drawImage(o, 0, 0), e.width = -1 < r.indexOf(i) ? o.naturalWidth : o.naturalHeight, e.height = -1 < r.indexOf(i) ? o.naturalHeight : o.naturalWidth;
                                                    var n = i * Math.PI / 180, a = .5 * e.width, l = .5 * e.height;
                                                    return t.clearRect(0, 0, e.width, e.height), t.translate(a, l), t.rotate(n), t.translate(.5 * -o.naturalWidth, .5 * -o.naturalHeight), t.drawImage(o, 0, 0), t.setTransform(1, 0, 0, 1, 0, 0), s.src = e.toDataURL(d.type, 1), void delete d.reader.exifOrientation
                                                }
                                                d.reader.node = s, d.reader.src = s.src, d.reader.width = s.width, d.reader.height = s.height, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height), g && u.revokeObjectURL(g), m(), c && (d.reader = {read: d.reader.read})
                                            }, s.onerror = function () {
                                                m(), d.reader = {read: d.reader.read}
                                            }
                                        };
                                        ...
                                        m(), d.reader = {read: d.reader.read}
                                    }, h ? n.thumbnails.useObjectUrl && n.thumbnails.canvasImage && u ? a.onload({target: {result: g = u.createObjectURL(d.file)}}) : a.readAsDataURL(d.file) : a.onload({target: {result: c ? d.data.thumbnail : d.file}})
                                } else if ("video" == d.format || "audio" == d.format) {
                                    var g, v = document.createElement(d.format), w = v.canPlayType(d.type);
                                    if (a.onerror = function () {
                                        d.reader.node = null, m(), d.reader = {read: d.reader.read}
                                    }, u && "" !== w) {
                                        if (r && !n.thumbnails.videoThumbnail) return d.reader.node = v, m(), void (d.reader = {read: d.reader.read});
                                        g = h ? u.createObjectURL(d.file) : d.file, v.onloadedmetadata = function () {
                                            ...
                                            d.data && d.data.readerCrossOrigin && v.setAttribute("crossOrigin", d.data.readerCrossOrigin), v.src = g + "#t=1"
                                        }, 100)
                                    } else a.onerror()
                            ...
                            if (null != n.maxSize && e) {
                                ...
                                if ($.each(f._itFl, function (e, t) {
                                    ...
                                    d += t.size
                                }), d > Math.round(1e6 * n.maxSize)) return a[1] = f._assets.textParse(n.captions.errors.filesSizeAll), a[3] = !0, a
                            }
                            ...
                            if (null != n.extensions && -1 == $.inArray(i.extension, n.extensions) && !n.extensions.filter(function (e) {
                                return -1 < e.indexOf(i.type) || -1 < e.indexOf(i.format + "/*")
                            ...
                            if (null != n.fileMaxSize && i.size > 1e6 * n.fileMaxSize) return a[1] = f._assets.textParse(n.captions.errors.fileSize, i), a;
                            if (4096 == i.size && "" == i.type) return a[1] = f._assets.textParse(n.captions.errors.folderUpload, i), a;
                            ...
                            if (!(-1 == f._itFl.indexOf(e) || e.upload && e.upload.$ajax)) {
                                var o = e, i = f.files.add($.extend(e, t), "updated");
                            ...
                            if (r || !n.onRemove || !$.isFunction(n.onRemove) || !1 !== n.onRemove(i, l, p, o, s)) {
                                if (i.html && (n.thumbnails.onItemRemove && $.isFunction(n.thumbnails.onItemRemove) && !r ? n.thumbnails.onItemRemove(i.html, l, p, o, s) : i.html.remove()), i.upload && i.upload.$ajax && i.upload.cancel && i.upload.cancel(!0), i.popup && i.popup.close && i.popup.close(), i.reader.src && (i.reader.node = null, URL.revokeObjectURL(i.reader.src)), i.input) {
                                    var a = !0;
                                    $.each(f._itFl, function (e, t) {
                        ...
                        f.reset(!0), f.bindUnbindEvents(!1), s.removeAttr("style"), p.before(s), delete s.get(0).FileUploader, p.remove(), p = o = l = null
                    }, _assets: {
                        bytesToText: function (e) {
                            ...
                            var o = Math.floor(e / 3600), i = Math.floor((e - 3600 * o) / 60), r = "";
                            return (0 < o || !t) && (r += (o < 10 ? "0" : "") + o + (t ? "h " : ":")), (0 < i || !t) && (r += (i < 10 && !t ? "0" : "") + i + (t ? "m " : ":")), r += ((e = e - 3600 * o - 60 * i) < 10 && !t ? "0" : "") + e + (t ? "s" : "")
                            ...
                            var o = new Date, i = function (e) {
                                return e < 10 && (e = "0" + e), e
                            };
                            e = e ? "." + e : "";
                            return (t = t || "") + o.getFullYear() + "-" + i(o.getMonth() + 1) + "-" + i(o.getDate()) + " " + i(o.getHours()) + "-" + i(o.getMinutes()) + "-" + i(o.getSeconds()) + e
                            ...
                            for (var o = atob(e.split(",")[1]), i = e.split(",")[0].split(":")[1].split(";")[0], r = new ArrayBuffer(o.length), n = new Uint8Array(r), a = 0; a < o.length; a++) n[a] = o.charCodeAt(a);
                            var l = new DataView(r);
                            return new Blob([l.buffer], {type: t || i})
                        }, getExifOrientation: function (e, p) {
                            var t = new FileReader, d = {1: 0, 3: 180, 6: 90, 8: 270};
                            t.onload = function (e) {
                                var t = new DataView(e.target.result), o = 1;
                                if (t.byteLength && 65496 == t.getUint16(0, !1)) for (var i = t.byteLength, r = 2; r < i && !(t.getUint16(r + 2, !1) <= 8);) {
                                    var n = t.getUint16(r, !1);
                                    if (r += 2, 65505 == n) {
                                        if (1165519206 != t.getUint32(r += 2, !1)) break;
                                        var a, l = 18761 == t.getUint16(r += 6, !1);
                                        r += t.getUint32(r + 4, l), a = t.getUint16(r, l), r += 2;
                                        for (var s = 0; s < a; s++) if (274 == t.getUint16(r + 12 * s, l)) {
                                            o = t.getUint16(r + 12 * s + 8, l), i = 0;
                                            break
                                        }
                                    } else {
            ...
            return n.enableApi && (s.get(0).FileUploader = {
                open: function () {
                    ...
                    var i;
                    if (e instanceof Blob) i = e; else {
                        var r = /data:[a-z]+\/[a-z]+\;base64\,/.test(e) ? e : "data:" + t + ";base64," + btoa(e);
                        i = f._assets.dataURItoBlob(r, t)
                    }
        ...
        editor: !1,
        sorter: !1,
        reader: {thumbnailTimeout: 5e3, timeout: 12e3},
        files: null,
        upload: null,
        dragDrop: !0,
        addMore: !1,
        ...
        captions: {
            ...
            feedback2: function (e) {
                return "Фото добавлено: " + e.length
            },
            confirm: "Confirm",
            cancel: "Cancel",
            name: "Name",
