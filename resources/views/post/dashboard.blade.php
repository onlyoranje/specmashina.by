                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <ul class="activity-log dashboard-block mt-0">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="form-group button mb-0 mt-0"><a href="{{route('post_add')}}" class="btn ">Добавить новость</a></div>
                                        </li>
                                        @if (count($posts)>0)
                                            ...
                                            @foreach ($posts as $post)
                                                ...
                                                <li>
                                                    ...
                                                    <span class="time"><a href='{{route('edit_post', ['post' => $post->id])}}'>Редактировать </a></span>
